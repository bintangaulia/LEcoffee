		...
		<body>
			  <header id="header" id="home">
			    ...
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="/"><img src="{{ asset('asset/img/logo.png') }}" alt="" title="" /></a>
				      </div>
				...
				<div class="container">
					<div class="row justify-content-start align-items-center">
						<div class="col-lg-6 video-right justify-content-center align-items-center d-flex">
							...
							<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid" src="{{ asset('asset/img/play-icon.png') }}" alt=""></a>
						</div>						
						<div class="col-lg-6 video-left">
							...
							<img class="img-fluid" src="{{ asset('asset/img/signature.png') }}" alt="">
						</div>
					</div>
				</div>	
			</section>
			...
			<section class="gallery-area section-gap" id="gallery">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-4">
							<a href="{{ asset('asset/img/g1.jpg') }}" class="img-pop-home">
								<img class="img-fluid" src="{{ asset('asset/img/g1.jpg') }}" alt="">
							</a>	
							<a href="{{ asset('asset/img/g2.jpg') }}" class="img-pop-home">
								<img class="img-fluid" src="{{ asset('asset/img/g2.jpg') }}" alt="">
							</a>	
						</div>
						<div class="col-lg-8">
							<a href="{{ asset('asset/img/g3.jpg') }}" class="img-pop-home">
								<img class="img-fluid" src="{{ asset('asset/img/g3.jpg') }}" alt="">
							</a>	
							<div class="row">
								<div class="col-lg-6">
									<a href="{{ asset('asset/img/g4.jpg') }}" class="img-pop-home">
										<img class="img-fluid" src="{{ asset('asset/img/g4.jpg') }}" alt="">
									</a>	
								</div>
								<div class="col-lg-6">
									<a href="{{ asset('asset/img/g5.jpg') }}" class="img-pop-home">
										<img class="img-fluid" src="{{ asset('asset/img/g5.jpg') }}" alt="">
									</a>	
								</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 single-review">
							<img src="{{ asset('asset/img/r1.png') }}" alt="">
						...
						<div class="col-lg-6 col-md-6 single-review">
							<img src="{{ asset('asset/img/r2.png') }}" alt="">
							<div class="title d-flex flex-row">
								<h4>lorem ipusm</h4>
								<div class="star">
									<span class="fa fa-star checked"></span>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 single-blog">
							<img class="img-fluid" src="{{ asset('asset/img/b1.jpg') }}" alt="">
							<ul class="post-tags">
						...
						<div class="col-lg-6 col-md-6 single-blog">
							<img class="img-fluid" src="{{ asset('asset/img/b2.jpg') }}" alt="">
							<ul class="post-tags">
								<li><a href="#">Travel</a></li>
								<li><a href="#">Life Style</a></li>
							</ul>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			...
			<script src="{{ asset('asset/js/superfish.min.js') }}"></script>	
